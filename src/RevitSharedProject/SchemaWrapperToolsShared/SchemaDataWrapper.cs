...
#else
       public void AddData(string name, System.Type typeIn, ForgeTypeId unit, SchemaWrapper subSchema)
      {
         m_DataList.Add(new FieldData(name, typeIn.FullName, unit.TypeId, subSchema));
      }
